// Seed data — initial state loaded when no persisted DB exists
...
export const SEED_EXAMS = [
  ...
  },
  {
    ...
    description: 'Web fundamentals quiz.',
    status: 'draft',
    createdBy: 'u2',
    duration: 15,
    passingScore: 60,
...
export const SEED_QUESTION_BANK = [
  ...
  { id: 'qb4', text: 'What does HTML stand for?', type: 'multiple-choice',
    options: ['Hyper Text Markup Language', 'High Tech Modern Language', 'Hyperlink Model Logic', 'Home Tool Markup Language'],
    correctOption: 0, topic: 'HTML', createdBy: 'u2', createdAt: '2026-02-01T10:00:00.000Z' },
...
// Backward-compatible exports used by old examService.js
export const exams = SEED_EXAMS;
export const users = SEED_USERS;
export const studentScores = SEED_ATTEMPTS.map(a => ({
